        ...
        <header>
            <div>
                <ul>
                    ...
                    <li className='icon-carrinho'>
                        <NavLink to="/carrinho">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" className="bi bi-cart-dash-fill" viewBox="0 0 16 16">
                            ...
                            <span className="contador-carrinho">{carrinho}</span>
                        </NavLink>
                    </li>
                </ul>
            </div>
